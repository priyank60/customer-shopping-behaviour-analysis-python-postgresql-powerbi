...
ROUND(AVG(purchase_amount),2) as avg_spent,sum(purchase_amount) from customer
...
select category,item_purchased,total_orders from cte where item_rank<=3

select * from customer
--Q9. Are customers who are repeat buyers (more than 5 previous purchases) also likely to subscribe?
select subscription_status,count(customer_id) as repeated_customer from customer where previous_purchases > '5' group by subscription_status
